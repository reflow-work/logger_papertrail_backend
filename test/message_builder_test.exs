defmodule LoggerPapertrailBackend.MessageBuilderTest do
  ...
  @meta [
    application: :upptec_slack_robot,
    module: UpptecSlack.SlackBot,
  ...
  test "will create a correct syslog message" do
    ...
    assert "<11>Oct  1 12:44:01 upptec_slack_robot UpptecSlack.SlackBot Hello PaperTrail!" ==
             message
  end
  ...
  test "will trim to long tags so it is still informational" do
    ...
    assert "<11>Oct  1 12:44:01 upptec_slack_robot Sub.VeryLongModuleName Hello PaperTrail!" ==
             message
  end
  ...
  test "in extrem cases, will only have last module name and trim it" do
    ...
    assert "<11>Oct  1 12:44:01 upptec_slack_robot VeryVeryLongLongLongModuleSenten Hello PaperTrail!" ==
             message
  end
  ...
  defp build_message(app, procid, log_level) do
    LoggerPapertrailBackend.MessageBuilder.build(
      "Hello PaperTrail!",
      log_level,
      app,
      @timestamp,
